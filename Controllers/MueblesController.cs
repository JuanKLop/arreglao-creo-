...
namespace ValorConFloat.Controllers
{
    public class MueblesController : Controller
    {
        ...
        public MueblesController(PruebaFloatContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (mueble == null)
            {
                return Json(new { success = false, message = "No se encontró el mueble a eliminar." });
            }
            ...
            try
            {
                ...
                return Json(new { success = true, message = "Mueble eliminado correctamente." });
            }
            catch (Exception ex)
            {
                return Json(new { success = false, message = "Ocurrió un error al intentar eliminar el mueble: " + ex.Message });
            }
        }
        [HttpPost]
