...
namespace ValorConFloat.Models;

public partial class PruebaFloatContext : DbContext
{
    public PruebaFloatContext()
    {
    }

    public PruebaFloatContext(DbContextOptions<PruebaFloatContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=DESKTOP-COFBV0T\\SQLSENA;Initial Catalog=PruebaFloat;integrated security=True; TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Idpaquete).HasName("PK__Paquetes__4C29513BCEEB6D7F");
        ...
        {
            entity.HasKey(e => e.Idpermiso).HasName("PK__Permisos__F11D75F336E83022");
        ...
        {
            entity.HasKey(e => e.Idrol).HasName("PK__Roles__A681ACB6519DF333");
        ...
        {
            entity.HasKey(e => e.IdrolPermiso).HasName("PK__RolesPer__3F09FABF21586D73");
        ...
        {
            entity.HasKey(e => e.Idusuario).HasName("PK__Usuarios__52311169DAB54B9C");
